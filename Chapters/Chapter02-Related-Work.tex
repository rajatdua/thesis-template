...
marginalia\marginpar{\scriptsize\url{http://lyx.org/}}, if they are very
  ...
  \begin{table}[h]
    ...
    \begin{minipage}{.5\linewidth}
      ...
      \begin{tabularx}{1.11\linewidth}{XcccccS} \toprule
        & \multicolumn{3}{c}{\textsc{\textsf{super aspect}}} & \multicolumn{2}{c}{\textsc{\textsf{super aspect}}} &\\
        \tableheadline{System} & \tableheadline{Aspect} & \tableheadline{Aspect} & \tableheadline{Aspect} & \tableheadline{Aspect} & \tableheadline{Aspect} & \tableheadline{Aspect} \\ \midrule
