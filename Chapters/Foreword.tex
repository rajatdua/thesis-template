...
occasionally need to download papers from ACM or IEEE. Aarhus
University has accounts with these and other publishers, so if you
access the sites from within AU (or through the AU VPN), you can
usually download without restriction.
